...
export const metadata: Metadata = {
  title: "Андрей Малик - Клинический Психолог",
  ...
  keywords: ["психолог", "ЭОТ", "КПТ", "Эмоционально-образная терапия", "психотерапия", "консультации", "Израиль", "онлайн терапия", "терапия"], 
  openGraph: {
