      ...
      >
        <div className="max-w-7xl mx-auto px-12">
          <div className="text-center mb-24">
            ...
            <p className="text-4xl text-amber-700/90 font-roslindale">שתרכשו</p> 
          </div>
            ...
            {[
              {
                ...
                description: "ליווי אישי שמאפשר להבין את החומר ולהגיע לשיעור מוכן ובטוח יותר."
              },
              {
                title: "השלמת פערים בחומר הלימוד",
                description: "עובדים מהבסיס, מסדרים בלבול ויוצרים הבנה יציבה לטווח ארוך."
              },
              {
                title: "הכנה והצלחה בבגרות",
                description: "תוכנית מסודרת שמובילה לציונים גבוהים ולביטחון ביום הבחינה."
              }
            ].map((skill, index) => (
              <motion.div 
                key={`skill-${index}`}
          ...
          <div className="grid grid-cols-2 gap-8 px-32">
            {[
              {
                title: "הסבר נושאים מורכבים באלגברה ובגאומטריה בשפה פשוטה",
                description: "מפרקים נוסחאות ורעיונות כך שהם סוף-סוף מתחילים להיות הגיוניים."
              },
              {
                title: "לימוד מדעי המחשב, כולל אלגוריתמים ומתמטיקה גבוהה",
                description: "הבנה עמוקה ולא שינון — חשיבה, לוגיקה וכלים שימושיים להמשך הדרך."
              }
            ].map((skill, index) => (
              <motion.div 
